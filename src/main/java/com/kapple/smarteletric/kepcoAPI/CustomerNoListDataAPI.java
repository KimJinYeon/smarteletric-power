...
public class CustomerNoListDataAPI implements KepcoAPI{

    private String serviceKey = "";
    private final String url = "https://opm.kepco.co.kr:11080/OpenAPI/getCustNoList.do";
    ...
    public List<JSONObject> getInnerJsonObjectList(JSONObject jsonObject) {
        ...
        JSONArray innerJsonObjectArray = jsonObject.getJSONArray("custNoInfoList");
